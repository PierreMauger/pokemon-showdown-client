...
export const Dex = new class implements ModdedDex {
	...
	getSpriteData(pokemon: Pokemon | Species | string, isFront: boolean, options: {
		...
		const cobblemonSprites = ['absol', 'accelgor', 'aegislash-blade', 'aegislash', 'aerodactyl', 'aggron', 'alakazam-f', 'alakazam', 'alcremie-caramelswirl', 'alcremie-lemoncream', 'alcremie-matchacream', 'alcremie-mintcream', 'alcremie-rainbowswirl', 'alcremie-rubycream', 'alcremie-rubyswirl', 'alcremie-saltedcream', 'alcremie', 'alomomola', 'altaria', 'ambipom-f', 'ambipom', 'amoonguss', 'ampharos', 'annihilape', 'araquanid', 'arbok', 'arboliva', 'arcanine', 'archeops', 'arctovish', 'arctozolt', 'ariados', 'armaldo', 'armarouge', 'aurorus', 'avalugg', 'azumarill', 'banette', 'barbaracle', 'barraskewda', 'basculegion-f', 'basculegion', 'basculin-bluestriped', 'basculin-redstriped', 'bastiodon', 'beartic', 'beedrill', 'beheeyem', 'bellibolt', 'bellossom', 'bewear', 'bibarel-f', 'bibarel', 'blastoise', 'blaziken-f', 'blaziken', 'blissey', 'boltund', 'bouffalant', 'brambleghast', 'braviary', 'breloom', 'bronzong', 'bruxish', 'butterfree-f', 'butterfree', 'cacturne-f', 'cacturne', 'camerupt', 'carbink', 'carracosta', 'centiskorch', 'ceruledge', 'cetitan', 'chandelure', 'charizard', 'chatot', 'chesnaught', 'chimecho', 'cinccino', 'cinderace', 'clawitzer', 'claydol', 'clefable', 'clodsire', 'cloyster', 'cofagrigus', 'comfey', 'conkeldurr', 'copperajah', 'corsola-galar', 'corviknight', 'crabominable', 'cradily', 'cramorant', 'crawdaunt', 'crobat', 'crustle', 'cryogonal', 'cursola', 'cyclizar', 'dachsbun', 'darmanitan', 'decidueye-hisui', 'decidueye', 'dedenne', 'delibird', 'delphox', 'dewgong', 'dhelmise', 'diggersby', 'ditto', 'dondozo', 'donphan-f', 'donphan', 'dracovish', 'dracozolt', 'dragalge', 'dragapult', 'dragonite', 'drampa', 'drapion', 'drednaw', 'drifblim', 'druddigon', 'dubwool', 'dudunsparce_two_segment', 'dugtrio-alola', 'dugtrio', 'dunsparce', 'durant', 'dusknoir', 'eelektross', 'eiscue-noice', 'eiscue', 'eldegoss', 'electivire', 'electrode-hisui', 'electrode', 'emboar', 'emolga', 'empoleon', 'escavalier', 'espathra', 'espeon', 'excadrill', 'exeggutor', 'exploud', 'falinks', 'farfetchd', 'farigiraf', 'fearow', 'feraligatr', 'ferrothorn', 'flamigo', 'flareon', 'floatzel', 'florges', 'flygon', 'forretress', 'froslass', 'furret', 'gallade', 'galvantula', 'garbodor', 'garchomp', 'gardevoir', 'garganacl', 'gastrodon-east', 'gastrodon', 'gengar', 'gholdengo', 'gigalith', 'glaceon', 'glalie', 'glimmora', 'gliscor', 'gogoat', 'golduck', 'golem-alola', 'golem', 'golisopod', 'golurk', 'goodra-hisui', 'gorebyss', 'gothitelle', 'gourgeist', 'grafaiai', 'granbull', 'grapploct', 'greedent', 'greninja', 'grimmsnarl', 'grumpig', 'gumshoos', 'gyarados', 'hariyama', 'hatterene', 'hawlucha', 'haxorus', 'heatmor', 'heracross', 'hippowdon', 'hitmonchan', 'hitmonlee', 'hitmontop', 'honchkrow', 'houndoom', 'huntail', 'hydreigon', 'illumise', 'incineroar', 'infernape', 'inteleon', 'jellicent-female', 'jellicent', 'jolteon', 'jumpluff', 'jynx', 'kabutops', 'kangaskhan', 'kecleon', 'kilowattrel', 'kingdra', 'klawf', 'kleavor', 'klefki', 'klinklang', 'komala', 'kommoo', 'kricketune', 'krookodile', 'lanturn', 'lapras', 'leafeon', 'leavanny', 'ledian', 'lickilicky', 'liepard', 'lilligant-hisui', 'linoone', 'lopunny', 'lucario', 'ludicolo', 'lumineon', 'lunatone', 'lurantis', 'luvdisc', 'luxray', 'mabosstiff', 'machamp', 'magcargo', 'magmortar', 'magnezone', 'malamar', 'mamoswine', 'manectric', 'mantine', 'maractus', 'marowak-alola', 'marowak', 'masquerain', 'maushold-four', 'mawile', 'meganium', 'meowscarada', 'metagross', 'mienshao', 'mightyena', 'milotic', 'miltank', 'mimikyu', 'minun', 'mismagius', 'morpeko-hangry', 'morpeko', 'mr-mime', 'mr-rime', 'mudsdale', 'muk-alola', 'muk', 'musharna', 'nidoking', 'nidoqueen', 'ninetales-alola', 'ninetales', 'ninjask', 'noctowl', 'noivern', 'obstagoon', 'octillery', 'oinkologne', 'omastar', 'orthworm', 'overqwil', 'pachirisu', 'palafin-hero', 'palafin', 'palossand', 'parasect', 'pelipper', 'perrserker', 'persian-alola', 'persian', 'pidgeot', 'pincurchin', 'pinsir', 'plusle', 'politoed', 'poliwrath', 'polteageist', 'porygonz', 'primarina', 'probopass', 'purugly', 'pyukumuku', 'quagsire', 'quaquaval', 'qwilfish', 'rabsca', 'raichu-alola', 'raichu', 'rampardos', 'rapidash-galar', 'rapidash', 'raticate-alola', 'raticate', 'relicanth', 'reuniclus', 'revavroom', 'rhyperior', 'ribombee', 'rillaboom', 'roserade', 'sableye', 'salamence', 'salazzle', 'samurott-hisui', 'samurott', 'sandaconda', 'sawsbuck-winter', 'sceptile', 'scizor', 'scolipede', 'scovillain', 'scrafty', 'seaking', 'serperior', 'sharpedo', 'shedinja', 'shiftry', 'shiinotic', 'shuckle', 'sigilyph', 'simipour', 'simisage', 'simisear', 'sinistcha', 'sirfetchd', 'skarmory', 'skeledirge', 'slaking', 'slowbro-galar', 'slowbro', 'slowking-galar', 'slowking', 'smeargle', 'sneasler', 'snorlax', 'solrock', 'spidops', 'spinda', 'spiritomb', 'squawkabilly', 'staraptor', 'starmie', 'steelix', 'stonjourner', 'stoutland', 'stunfisk-galar', 'stunfisk', 'substitute', 'sudowoodo', 'swampert', 'swanna', 'swellow', 'swoobat', 'sylveon', 'talonflame', 'tangrowth', 'tatsugiri', 'tauros-paldeaaqua', 'tauros-paldeablaze', 'tauros-paldeacombat', 'tauros', 'tentacruel', 'thievul', 'tinkaton', 'toedscruel', 'togedemaru', 'togekiss', 'torkoal', 'torterra', 'toucannon', 'toxapex', 'toxicroak_male', 'toxtricity_amped', 'toxtricity_lowkey', 'trevenant', 'tropius', 'tsareena', 'turtonator', 'typhlosion-hisui', 'typhlosion', 'tyranitar', 'tyrantrum', 'umbreon', 'unfezant', 'unown', 'ursaluna', 'ursaring', 'vanilluxe', 'vaporeon', 'veluza', 'venomoth', 'venusaur', 'vespiquen', 'victreebel', 'vileplume', 'vivillon', 'volbeat', 'volcarona', 'wailord', 'walrein', 'watchog', 'weavile', 'weezing-galar', 'weezing', 'whimsicott', 'whiscash', 'wigglytuff', 'wobbuffet', 'wugtrio', 'wyrdeer', 'xatu', 'yanmega', 'zebstrika', 'zoroark-hisui', 'zoroark'];
		if (!Dex.prefs('noanim') && !Dex.prefs('nogif') && spriteData.gen >= 5) {
			...
			for (const [animationData, animDir] of animationArray) {
				...
				if (cobblemonSprites.includes(name)) {
